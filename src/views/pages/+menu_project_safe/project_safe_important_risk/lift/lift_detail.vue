<template>
  <div id="lift-detail">
    <div class="item-select">
      ...
      <el-row class="row-item" v-if="!(code == '0402020203' || code == '0402020201')">
        <span>租赁单位:</span>
      ...
      <el-row
        class="row-item"
        v-if="!(code == '0402020203')"
      >
        <span>施工升降机编号:</span>
        {{addCheckForm.liftNum | accordingIdFindName(filterList)}}
      </el-row>
      <el-row class="row-item" v-if="!(code == '0402020203' || code == '0402020201' || code == '0402020202')">
        <span>型号:</span>
    ...
    <el-container class="go-back">
      ...
      <el-button size="medium" type="primary" @click="gotoUpdate" v-if="action == 'affirm' || action == 'review'">修改</el-button>
