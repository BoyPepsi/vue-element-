  ...
  <div id="lift-add">
    <div class="item-select">
      <el-form :model="addCheckForm" :rules="rule" ref="addCheckForm" label-width="130px">
        ...
        <el-row class="row-item" v-if="code !== '0402020203'">
          <el-form-item prop="liftNum" label="施工升降机编号:">
        ...
        <el-row
          class="row-item"
          v-if="!(code == '0402020203' || code == '0402020202' || code == '0402020201')"
        >
...
export default {
  data() {
    return {
      ...
      rule: {
        ...
        liftNum: [
          { required: true, message: "请填写施工升降机编号", trigger: "blur" },
        ],
        leaseUnit: [
  ...
  created() {
    ...
    this.getSelectList("04020202", "checkBranchCodeList");
    if (this.$route.query) {
