  ...
  <div id="lift-add">
    <div class="item-select">
      <el-form :model="addCheckForm" :rules="rule" ref="addCheckForm" label-width="130px">
        ...
        <el-row class="row-item" v-if="!(code == '0402020502' || code == '0402020503')">
        ...
        <el-row class="row-item" v-if="code !== '0402020502'">
          <el-form-item prop="liftNum" label="物料提升机编号:">
            <el-input :disabled="itemId.length>0" v-model="addCheckForm.liftNum" style="width:76%"></el-input>
          </el-form-item>
        </el-row>

        <el-row class="row-item">
          <el-form-item prop="model" label="型号:" v-if="code == '0402020504' || code == '0402020505'">
...
export default {
  data() {
    return {
      ...
      rule: {
        ...
        liftNum: [
          { required: true, message: "请填写物料提升机编号", trigger: "blur" },
        ],
        leaseUnit: [
  ...
  created() {
    ...
    this.getSelectList("04020205", "checkBranchCodeList");
    if (this.$route.query) {
