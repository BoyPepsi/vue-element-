<template>
  <div class="week-safe-add-question">
    <div id="basement-week" >
      <el-form :model="addCheckForm" :rules="rule" ref="addCheckForm" label-width="140px">
        <el-row class="row-item">
          <el-form-item prop="projectCode" label="检查项目:">
            <el-select
              placeholder="请选择"
              v-model="addCheckForm.projectCode"
              style="width:76%"
...
export default {
  ...
  methods: {
    ...
    projectCodeChange(code) {
      this.addCheckForm.questionCode = "";
      this.getSelectList(code, "childList");
      this.questionCode = "";
    },
