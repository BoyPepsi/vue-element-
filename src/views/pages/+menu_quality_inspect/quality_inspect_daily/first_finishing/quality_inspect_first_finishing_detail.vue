<template>
  <div id="first-finishing-detail">
    <div class="item-select">
      ...
      <el-row class="row-item" v-if="code == '0401010310' || code == '0401010309' || code == '0401010306'">
        <span>分包单位:</span>
      ...
      <el-row class="row-item" v-if="tableList.length == 0 || !tableList">
        <span>楼层:</span>
        {{addCheckForm.floorNum | accordingIdFindName(filterList)}}
      </el-row>
      <el-row class="row-item">
        <span>工种:</span>
        {{addCheckForm.peopleCode | accordingIdFindName(filterList)}}
        <span></span>
        {{addCheckForm.people | accordingIdFindName(filterList)}}
      </el-row>
      <el-row class="row-item" v-if="code == '0401010303' || code == '0401010305'">
        <span>工种:</span>
        {{code == '0401010303'? '外墙涂料施工人数' : code =='0401010305' ? '全轻混凝土地面施工人数' : '' }}
        <span></span>
        {{addCheckForm.peopleTwo | accordingIdFindName(filterList)}}
      </el-row>
    </div>
