<template>
  <div id="basement-detail">
    <div class="item-select">
      ...
      <el-row class="row-item">
        <span>地下室区块:</span>
        {{addCheckForm.bidBasementId | accordingIdFindName(filterList)}}
      </el-row>
      <el-row class="row-item" v-if="addCheckForm.floorNum !== ''">
        <span>楼层:</span>
        {{addCheckForm.floorNum | accordingIdFindName(filterList)}}
      </el-row>
      <el-row class="row-item" v-if="addCheckForm.hight !== ''">
        <span>楼层:</span>
        {{addCheckForm.hight | accordingIdFindName(filterList)}}
      </el-row>
      <el-row class="row-item">
        <span>工种:</span>
