  ...
  <div id="quality-inspect">
      ...
      <el-row :gutter="40">
        <el-col :span="8">
          <el-form-item label="工程阶段" prop="projectCode">
            <el-select v-model="check.projectCode" @change="getCode($event)">
              <el-option
        ...
        <el-col :span="8">
          <el-form-item>
            <el-button v-permission="{action: 'qualityInspect:inspectMainStructure:save' }" @click="addCheck">开始检查</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
    ...
    <div class="table">
      ...
      >
        ...
        <!-- <el-table-column label="人员种类" prop="peopleTypeName" align="center" ></el-table-column>
        <el-table-column label="人员数量" prop="people" align="center" ></el-table-column> -->
        ...
        <el-table-column label="复核人" prop="checktor" align="center"></el-table-column>
        ...
        <el-table-column label="操作" prop="name" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              v-permission="{action: 'qualityInspect:inspectMainStructure:detail' }"
            >详情</el-button>
            <el-button
              size="mini"
              type="text"
              ...
              v-permission="{action: 'qualityInspect:inspectMainStructure:update' }"
            ...
            <el-button
              ...
              v-permission="{action: 'qualityInspect:inspectMainStructure:review' }"
            ...
            <el-button
              ...
              v-permission="{action: 'qualityInspect:inspectMainStructure:delete' }"
            >删除</el-button>
          </template>
        </el-table-column>
      </el-table>
