<template>
  <div>
    ...
    <addQuestionsNew class="add-questions-wrap" ref="addQuestion" code="040102030202"></addQuestionsNew>
    ...
    <div class="btn-box">
      <el-row class="row-button">
        ...
        <el-button style="float: right" @click="confirm">涂料防水验收检查</el-button>
      </el-row>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
     ...
     */
    confirm() {
      this.$confirm("请确认附加层、涂膜层检查工序已完成", "提示", {
