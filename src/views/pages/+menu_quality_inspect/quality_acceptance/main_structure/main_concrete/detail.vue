    ...
    <div class="child-list" v-for="(item) in childList" :key="item.mainId">
      ...
      <el-row>
        <el-table :data="item.mixedSpace" border>
          ...
          <el-table-column prop="cumulative" label="累计浇筑方量（m3）" align="center"></el-table-column>
          <el-table-column prop="standard" label="标养试块组数" align="center"></el-table-column>
          <el-table-column prop="penetration" label="同条件试块组数" align="center"></el-table-column>
