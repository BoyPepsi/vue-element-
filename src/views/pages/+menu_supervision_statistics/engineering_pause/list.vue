  ...
  <div class="bigbox">
    <div class="search">
      ...
      <el-button
        ...
        type="primary"
        @click="goToAdd"
        v-permission="{action: 'engineeringPause:save' }"
      >生成工程暂停单</el-button>
    </div>
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column align="center" label="停工时间">
          <template slot-scope="scope">{{ scope.row.stopTime | transformDate2 }}</template>
        </el-table-column>
        ...
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button
              ...
              v-permission="{action: 'engineeringPause:detail' }"
            >详情</el-button>
            <el-button
              type="text"
              size="small"
              @click="download(scope.row)"
              v-permission="{action: 'engineeringPause:download' }"
            >下载</el-button>
            <el-button
              style="color:red"
              type="text"
              ...
              v-permission="{action: 'engineeringPause:delete' }"
            >删除</el-button>
          </template>
        </el-table-column>
      </el-table>
