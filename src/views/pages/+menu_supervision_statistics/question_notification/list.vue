  ...
  <div class="bigbox">
    <div class="search">
      ...
      <el-button
        ...
        type="primary"
        @click="goToAdd"
        v-permission="{action: 'questionNotification:save' }"
      >生成巡查问题通知单</el-button>
    </div>
        ...
        <el-table-column align="center" label="操作">
          <template slot-scope="scope">
            <el-button
              ...
              v-permission="{action: 'questionNotification:detail' }"
            >详情</el-button>
            <el-button
              type="text"
              size="small"
              @click="download(scope.row)"
              v-permission="{action: 'questionNotification:download' }"
            >下载</el-button>
            <el-button
              style="color:red"
              type="text"
              ...
              v-permission="{action: 'questionNotification:delete' }"
            >删除</el-button>
          </template>
        </el-table-column>
      </el-table>
